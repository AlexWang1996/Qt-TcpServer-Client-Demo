...
static const char qt_meta_stringdata_Processor[] = {
    "Processor\0\0renewUI()\0work()\0"
};
...
const QMetaObjectExtraData Processor::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Processor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Processor,
      qt_meta_data_Processor, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Processor::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Processor))
